...
def bot():
    ...
    bot = DiscordBot(intents=intents, openai_handler=openai_handler,
                     log_file_path=log_file_path, user_scores_path=user_scores_path)
...
def test_init(bot):
    ...
    bot = DiscordBot(intents=test_intents, openai_handler=test_openai_handler,
